# RabbitMQ consumer and sender -- Java Sample

This is a java version of this go demo: https://github.com/kedacore/sample-go-rabbitmq/blob/master/README.md
...
```cli
kubectl apply -f rabbitMQReceiver/deploy-publisher-job.yaml
```
